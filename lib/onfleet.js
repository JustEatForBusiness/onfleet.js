...
class Onfleet {
     ...
     */
    getWebhooks() {
        return this.get('/webhooks').then(response => JSON.parse(response));
    }
    ...
    /**
     * Adds basic access authentication to the options object.
     *
    ...
    /**
     * Appends path to the api base in order to get a full endpoint URI.
     *
     * @param {string} path
     * @returns {string}
     */
